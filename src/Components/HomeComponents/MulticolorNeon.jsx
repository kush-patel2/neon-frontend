  ...
  return (
    ...
    <div class="container">
      <div class="row flex-lg-row flex-column justify-content-center">
        ...
        <div class="col-lg-6 text-center ps-lg-4 text-lg-start">
          <h6 className='sub_head'>Experience the rainbow with MultiColor Neon</h6>
          <h3 className='s_head'>About MultiColor Neon</h3>
          <p className='h_body'>Multi-Color Neon offers a dazzling array of hues that can create a unique, eye-catching atmosphere for any occasion, from parties to business events, showcasing a spectrum of colors that's sure to impress and inspire.</p>
