        ...
        <div className="container">
          <div className="row flex-lg-row flex-column justify-content-center">
            <div className="col-lg-6 text-center text-lg-start">
              ...
              <p className="h_body">
                When you hear the words ‘neon lights’, the first things that
                come to your mind are storefront signs. Neon lights ideal for
                the advertising industry because they can easily catch the
                attention of passersby. Neon lights usually come in the form of
                glass tubes which you can fabricate in different artistic shapes
                to create pictures of letters. They are popularly used in making
